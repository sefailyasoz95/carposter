		...
		<section className='relative min-h-[90vh] flex items-center justify-center overflow-hidden'>
			...
			<div className='relative z-10 mx-auto max-w-5xl px-4 sm:px-6 text-center'>
				...
				<h1 className='text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-white leading-[0.9] tracking-tight mb-6'>
					...
					<br />
					Into <span className='text-white'>Art</span>
				</h1>

				<p className='mt-6 text-lg sm:text-xl text-zinc-400 max-w-2xl mx-auto leading-relaxed'>
					Upload your car photo, choose a poster style, and let AI transform it into a stunning print-quality artwork.
					From cinematic to retro, we have every vibe.
				</p>
				...
				<div className='mt-10 flex flex-col sm:flex-row items-center justify-center gap-4'>
					...
					<Link href='/gallery'>
						<Button
							size='xl'
							variant='outline'
							className='border-zinc-600 text-zinc-200 hover:text-white hover:border-zinc-400 hover:bg-white/5 bg-transparent'>
							See Examples
						</Button>
					</Link>
				</div>
				...
				<div className='mt-14 flex flex-wrap items-center justify-center gap-8 text-zinc-400 text-sm'>
					{[
						{ value: "1K+", label: "Posters Created" },
						{ value: "15+", label: "Unique Styles" },
						{ value: "4.9★", label: "Average Rating" },
						{ value: "< 100s", label: "Generation Time" },
					].map(({ value, label }) => (
